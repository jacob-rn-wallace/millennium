...
Mouse 1's dock (C-BN34) carries PCB date code FMa060304. Physical inspection of all seven docks in the collection has established that this date code is identical across every specimen regardless of manufacture date — including Dock 4, manufactured in 2007. It therefore represents the **PCB design revision date** (June 3, 2004) rather than a manufacture date. See [`mx1000-dock-catalog.md`](mx1000-dock-catalog.md) for full dock PCB findings.
